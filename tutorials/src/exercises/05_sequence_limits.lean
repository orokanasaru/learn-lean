...
begin
  intro h,
  cases h (l/2) (by linarith) with w hw,
  use w,
  intros n hn,
  specialize hw n hn,
  rw abs_le at hw,
...
begin
  ...
  intros n hn,
  rw ge_max_iff at hn,
  specialize hn₁ n hn.left,
  specialize hn₂ n hn.right,
  specialize h n,
  specialize h' n,
  rw abs_le at *,
  split; linarith,
...
begin
  ...
  cases hu₁ (ε/2) (by linarith) with n₁ hn₁,
  cases hu₂ (ε/2) (by linarith) with n₂ hn₂,
  generalize hn : max n₁ n₂ = n,
  cases ge_max_iff.mp (ge_of_eq (eq.symm hn)) with hl hr,
  specialize hn₁ n hl,
  specialize hn₂ n hr,
  calc
