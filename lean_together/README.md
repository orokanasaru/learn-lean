...
The `component.tsx` file contains the Fluid component and the logic for our data model.
...
The `view.tsx` file contains all the view logic.
...
.
├── src
|   ├── component.tsx              // Fluid Component source code
|   ├── index.ts                   // Export file
|   ├── interface.ts               // Model Interface Definition
|   └── view.tsx                   // View Logic
├── tests
|   └── component.test..tsx         // Fluid Component test
